    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Container(
          ...
          height: 170,
          decoration: BoxDecoration(color: Color(0xff860a97)),
          child:
        ...
        Padding(
          ...
          child: Row(
            children: [
              buildFileSizeChart("LABIALES", Colors.blue, .3),
              const SizedBox(
                width: 2,
              ),
              buildFileSizeChart("ESMALTES", Color(0xfff436eb), .25),
              const SizedBox(
                width: 2,
              ),
              buildFileSizeChart("CEJAS", Colors.yellow, .20),
              const SizedBox(
                width: 2,
              ),
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              Row(
                children: [
                  buildFileColumn('favorito', 'Labiales', '.tonos'),
                  SizedBox(
                    width: availableScreenWidth * .03,
                  ),
                  buildFileColumn('favorito', 'Esmaltes', '.tonos'),
                  SizedBox(
                    width: availableScreenWidth * .03,
                  ),
                  buildFileColumn('diamante', 'Cejas', '.laminadas'),
                ],
              ),
              const Divider(
                height: 60,
              ...
              // Folder List
              buildProjectRow("Labios"),
              buildProjectRow("Rostro"),
              buildProjectRow("Esmaltes"),
              buildProjectRow("Ojos"),
            ],
          ),
        )
      ]),
